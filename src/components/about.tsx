    ...
    <section id="about" className="py-24 sm:py-32 bg-surface">
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          <div className="space-y-6">
            <div className="rounded-2xl bg-surface-light border border-white/5 p-8 space-y-6">
              <h3 className="text-xl font-bold">What Drives Greg</h3>
              <div className="space-y-5">
                <div className="flex gap-4">
                  <div className="mt-1 flex-shrink-0 w-10 h-10 rounded-xl bg-accent/10 flex items-center justify-center">
                  ...
                  <div>
                    <p className="font-semibold text-white">Comeback Stories</p>
                ...
                <div className="flex gap-4">
                  ...
                  <div>
                    <p className="font-semibold text-white">Cancer Survivor Fitness</p>
                    <p className="text-muted text-sm mt-1">
                ...
                <div className="flex gap-4">
                  ...
                  <div>
                    <p className="font-semibold text-white">Positive Energy</p>
                    <p className="text-muted text-sm mt-1">
            ...
            <div className="rounded-2xl bg-surface-light border border-white/5 p-8">
              <h3 className="text-xl font-bold mb-4">Off the Clock</h3>
              <div className="flex flex-wrap gap-3">
                {["Boxing", "Basketball", "Hiking", "Family Time"].map(
                  (hobby) => (
                    <span
                      key={hobby}
                      className="rounded-full bg-accent/10 border border-accent/20 px-4 py-2 text-sm text-accent font-medium"
                    >
                      {hobby}
                    </span>
                  )
