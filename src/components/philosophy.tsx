export function Philosophy() {
  return (
    <section id="philosophy" className="py-24 sm:py-32 relative overflow-hidden">
      {/* Background effects */}
      ...
      <div className="relative mx-auto max-w-4xl px-6 lg:px-8 text-center">
        {/* Quote icon */}
        <div className="mx-auto w-16 h-16 rounded-full bg-accent/10 flex items-center justify-center mb-10">
          <svg
        ...
        <p className="mt-8 text-muted text-lg">— Gregory N., Jr.</p>

        {/* Divider */}
        <div className="w-20 h-0.5 bg-accent/30 mx-auto my-12" />
        ...
        {/* Daily inspiration */}
        <div className="mt-16 rounded-2xl bg-surface border border-white/5 p-8 max-w-xl mx-auto">
          ...
          <p className="mt-4 text-muted text-sm">— Greg Nichols</p>
        </div>
      </div>
    </section>
  );
